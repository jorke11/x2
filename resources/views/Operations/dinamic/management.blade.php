    ...
    <div class="col-lg-4 col-lg-offset-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::open(['id'=>'frm']) !!}
                <input type="hidden" id="id" name="id" class="input-dinamic">   
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label for="address" class="control-label">Description</label>
                            <input type="text" class="form-control input-dinamic" id="description" name="description" placeholder="description">
                        </div>
                    </div>
                </div>
            </div>
